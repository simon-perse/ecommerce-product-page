...
{
    console.log("failed to convert number_of_articles to int")
}
...
shoppin_basket_array.forEach(function (item, index) {
...
shopping_cart_btn.addEventListener("click", openShoppingBasketWindow);



// function generateAddToBasketModal(){
//     // CREATING ELEMENTS,ASSIGNING CSS IDs/CLASSES and SETTING STATIC VALUES
...
//     add_to_cart_img.src="/images/image-product-1-thumbnail.jpg"; //make dynamic
//     add_to_cart_container.appendChild(add_to_cart_img);
//     add_to_cart_container.appendChild(add_to_cart_product_container);    
//     add_to_cart_product_name.textContent="Fall Limited Edition Sneakers";//make dynamic
//     add_to_cart_product_container.appendChild(add_to_cart_product_name);
//     add_to_cart_price.innerHTML="$125 x3 <b>$375 </b>"; //make dynamic
...
<div class="add-to-cart-window">
<div class="add-to-cart-header">
  <h3 class="add-to-cart-header-text">Cart</h3>
</div>
<div class="add-to-cart-container">
  <img class= "add-to-cart-img" src="/images/image-product-1-thumbnail.jpg"/>
  <div class="add-to-cart-product-container">
  <h4 class="add-to-cart-product-name">Fall Limited Edition Sneakers </h4>
  <div>
  <span id="add-to-cart-price">$125.00 </span><span id="add-to-cart-quantity">x3</span> <span id="add-to-cart-total">$375.00</span>
</div>    
</div>
<button id="add-to-cart-remove-item">
  <svg alt="remove item" width="14" height="16" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><defs><path d="M0 2.625V1.75C0 1.334.334 1 .75 1h3.5l.294-.584A.741.741 0 0 1 5.213 0h3.571a.75.75 0 0 1 .672.416L9.75 1h3.5c.416 0 .75.334.75.75v.875a.376.376 0 0 1-.375.375H.375A.376.376 0 0 1 0 2.625Zm13 1.75V14.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 1 14.5V4.375C1 4.169 1.169 4 1.375 4h11.25c.206 0 .375.169.375.375ZM4.5 6.5c0-.275-.225-.5-.5-.5s-.5.225-.5.5v7c0 .275.225.5.5.5s.5-.225.5-.5v-7Zm3 0c0-.275-.225-.5-.5-.5s-.5.225-.5.5v7c0 .275.225.5.5.5s.5-.225.5-.5v-7Zm3 0c0-.275-.225-.5-.5-.5s-.5.225-.5.5v7c0 .275.225.5.5.5s.5-.225.5-.5v-7Z" id="a"/></defs><use fill="#C3CAD9" fill-rule="nonzero" xlink:href="#a"/></svg>
</button>
</div>
<button id="add-to-cart-checkout"> Checkout</button>
</div>
`
function openShoppingBasketWindow(){
if(!shopping_cart_btn.classList.contains("active"))
{
shopping_cart_btn.classList.add("active");
product_page_container.insertAdjacentHTML("afterbegin", shopping_cart_html);
}
else if(shopping_cart_btn.classList.contains("active"))
{
shopping_cart_btn.classList.remove("active");
